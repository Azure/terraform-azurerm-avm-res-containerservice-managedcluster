...
output "aks_cluster_name" {
  value = module.stateful-workloads.name
}

output "aks_kubelet_identity_id" {
  value = module.stateful-workloads.kubelet_identity_id
}

output "aks_nodepool_resource_ids" {
  value = module.stateful-workloads.nodepool_resource_ids
}

output "aks_oidc_issuer_url" {
  value = module.stateful-workloads.oidc_issuer_url
}
