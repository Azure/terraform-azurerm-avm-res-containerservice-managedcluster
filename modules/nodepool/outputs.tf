...
output "resource" {
  description = "The node pool resource."
  value       = var.create_nodepool_before_destroy ? azurerm_kubernetes_cluster_node_pool.create_before_destroy_node_pool : azurerm_kubernetes_cluster_node_pool.this
}
